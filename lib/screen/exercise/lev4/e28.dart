...
class Exercise28 extends StatefulWidget {
  const Exercise28({super.key});

  @override
  State<Exercise28> createState() => _Exercise28State();
}

class _Exercise28State extends State<Exercise28> {
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    String result = Level4.longestSubstring(strings).toString();
                    showDialog(
                      context: context,
                      builder: (context) {
                        return AlertDialog(
