...
class Exercise34 extends StatefulWidget {
  const Exercise34({super.key});

  @override
  State<Exercise34> createState() => _Exercise34State();
}

class _Exercise34State extends State<Exercise34> {
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    int result = Level4.longestIncreasingSubsequence(numbers);
                    showDialog(
                      context: context,
                      builder: (context) {
                        return AlertDialog(
