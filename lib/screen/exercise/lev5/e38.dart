...
class Exercise38 extends StatefulWidget {
  const Exercise38({super.key});

  @override
  State<Exercise38> createState() => _Exercise38State();
}

class _Exercise38State extends State<Exercise38> {
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    List<int> result = Level5.uniq(numbers);
                    showDialog(
                      context: context,
                      builder: (context) {
                        return AlertDialog(
