...
class Exercise15 extends StatefulWidget {
  const Exercise15({super.key});

  @override
  State<Exercise15> createState() => _Exercise15State();
}

class _Exercise15State extends State<Exercise15> {
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    int result = Level2.maxSum(numbers);
                    showDialog(
                      context: context,
                      builder: (context) {
                        return AlertDialog(
