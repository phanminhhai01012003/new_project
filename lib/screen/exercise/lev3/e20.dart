...
class Exercise20 extends StatefulWidget {
  const Exercise20({super.key});

  @override
  State<Exercise20> createState() => _Exercise20State();
}

class _Exercise20State extends State<Exercise20> {
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    int result = Level3.findSecondSmallest(numbers, context);
                    showDialog(
                      context: context,
                      builder: (context) {
                        return AlertDialog(
